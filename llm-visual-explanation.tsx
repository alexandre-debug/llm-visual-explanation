...
const LLMVisualExplanation = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gray-50 min-h-screen">
      ...
      <div className="mt-4 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg p-4 text-white text-center">
        <div className="text-sm mb-2">Criado por Alexandre Cardoso</div>
        <a 
          href="https://www.linkedin.com/in/alexandre-cardoso-b47353184/" 
          target="_blank" 
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 bg-white bg-opacity-20 hover:bg-opacity-30 px-4 py-2 rounded-lg transition-all duration-200 text-white font-semibold"
        >
